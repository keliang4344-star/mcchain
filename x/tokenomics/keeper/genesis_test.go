...
const (
	...
	ecosystemAmt  = uint64(82_500_000_000_000)  // 设备激励 55% 内切出的十代推荐返佣生态预算（→ referral.ecosystem，供十代推荐返佣领取）
...
// TestInitGenesis 验证 tokenomics InitGenesis（五池模型编排）：
...
func TestInitGenesis(t *testing.T) {
	...
	// ③b 十代推荐返佣生态模块账户余额 == 8.25e13（由 tokenomics 从设备激励池切出拨付，供十代推荐返佣 ClaimRewards）。
