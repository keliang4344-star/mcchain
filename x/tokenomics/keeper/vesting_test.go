...
// TestComputeVested 验证释放曲线计算（建模口径：1 年 cliff + 3 年线性 = 总 4 年）：
...
// TestComputeVested_TotalAboveMaxInt64 是溢出防护的核心回归：
//
// 朴素实现 `sdk.NewInt(int64(totalLocked))` 在 totalLocked > MaxInt64（9.2e18）时
