...
// mockPhonenode 记录 slash 调用，供 cheat 裁定断言。
...
// TestResolveDisputeCheat 仲裁者裁定 cheat → 任务标记作弊 + 提交者被 slash + 不发币。
...
// TestResolveDisputeHonest 仲裁者裁定 honest → 争议结案，任务不标记作弊（BeginBlock 将照常拨付）。
