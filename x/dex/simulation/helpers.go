...
// makeEncoding builds an encoding config that registers only the dex custom
// Msgs, avoiding import cycles with the app package.
...
// simulation framework. If the module logic rejects the message (e.g. pool not
// found), the framework records it as skipped.
func genDeliver(
	r *rand.Rand,
	app *baseapp.BaseApp,
	ctx sdk.Context,
