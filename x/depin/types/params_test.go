...
// DefaultParams must lock InitialPool=4.675e14 (umc) — 即设备激励池整体
...
// NewParams must equal DefaultParams.
func TestNewParams(t *testing.T) {
	require.Equal(t, DefaultParams(), NewParams())
}

// ParamSetPairs must register both params with the correct keys, and the
...
// Params.Validate must pass for defaults and fail for empty pool/denom.
