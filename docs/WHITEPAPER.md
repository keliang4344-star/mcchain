...
> 4. **共识共生**——MC 的激励来自真实的设备贡献与网络安全，不设任何以招募成员为收益来源的结构。
>
...
与基金会池同理，早期开发池在创世时**全额（5000 万 MC）直接拨付到开发资助地址（可支出）**，T0 即流通，按公开的开发资助名单逐笔发放——不滞留模块账户，让最早的建设者能及时获得回馈。
...
| 基金会释放（T0 即时 + 2 年线性） | 50,000,000,000,000 / 80,000,000,000,000 | 5000 万 / 8000 万 | `FoundationT0Unlock=5e13` |
| 早期开发释放（T0 全额） | 50,000,000,000,000 | 5000 万 | — |
...
| 第 12 月 | 5000 万 + ≈ 4000 万 | 8000 万 × (12/24) |
...
**Q2：用一部普通手机，需要买 3 万 MC 才能参与吗？**
不需要。3 万 MC 是**验证人**的最低自抵押门槛。普通用户用手机参与的是**设备激励（DePIN）**，只需通过设备认证、保持在线并完成任务，门槛极低，与 3 万 MC 无关。这是两条完全不同的参与路径。
