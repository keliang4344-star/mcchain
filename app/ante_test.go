...
// MsgCreateValidator MinSelfDelegation floor enforcement.
...
// MsgEditValidator MinSelfDelegation floor enforcement + zero-value skip.
...
// tx with no relevant messages must pass straight through to next.
